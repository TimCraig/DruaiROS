...
bool DDiffDrive::TwistRPS(int32_t nLinearSpeed, double dOmega, bool bAdjustAccel /* = true */)
   ...
   int32_t nAngularSpeed = (LengthToCnts(m_dWheelBase / 2)) * dOmega;
...
bool DDiffDrive::RadiusTurn(int32_t nSpeed, double dRadius, ETurn eTurn, bool bAdjustAccel /* = true */) const
   {
   bool bRet = false;
