...
class DDiffDrive : public DRoboClawFS
   ...
   public:
      ...
      *****************************************************************************/
      ...
      class MotorMotionParams
         ...
         public:
            ...
            MotorMotionParams(const MotorMotionParams& src)
               {
               m_nSpeed = src.m_nSpeed;
               m_uAccel = src.m_uAccel;
               m_uDecel = src.m_uDecel;
               m_uDistance = src.m_uDistance;
               return;
               }
            ...
            MotorMotionParams& operator=(const MotorMotionParams& rhs)
               {
               m_nSpeed = rhs.m_nSpeed;
               m_uAccel = rhs.m_uAccel;
               m_uDecel = rhs.m_uDecel;
               m_uDistance = rhs.m_uDistance;
               return (*this);
               }
      ...
      *****************************************************************************/
      ...
      bool RadiusTurn(int32_t nLinearSpeed, double dRadius, ETurn eTurn, bool bAdjustAccel = true) const;
